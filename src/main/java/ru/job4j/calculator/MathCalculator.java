...
public class MathCalculator {
    ...
    public static double sumOfAllFourSimpleOperations(double first, double second) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета равен: " + sumOfAllFourSimpleOperations(10, 20));
    }
}
